...
PROVIDERPATH = "~/oqs-provider/_build/oqsprov"
...
if __name__=="__main__":
    ...
    self_sign_cert = f'openssl req -x509 -new -key ./tmp/{SUBJECT}.key -outform DER -out ./tmp/{SUBJECT}.der -nodes -subj "/C=FI/O=Teknologian tutkimuskeskus VTT/CN=QKD-LAPTOP" -days 365 -provider-path {PROVIDERPATH} -provider oqsprovider -provider default'
